...
def calc_values(emax1, emax2, emax3, edge_thresh=35):
    """
...
def determine_resize(img, fixed_size=1024):
    """
...
def blur_result(size, per, blur_extent, fixed_size=1024, min_zero=0):
    """
